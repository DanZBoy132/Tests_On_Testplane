...
export declare function createBidiConnection(webSocketUrl: string, options?: WebSocket.ClientOptions): Promise<WebSocket | undefined>;
/**
 ...
 */
export declare function connectWebsocket(candidateUrls: string[], options?: WebSocket.ClientOptions): Promise<WebSocket | undefined>;
