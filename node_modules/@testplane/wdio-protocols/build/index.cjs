...
__export(index_exports, {
  AppiumProtocol: () => appium_default,
  CAPABILITY_KEYS: () => CAPABILITY_KEYS,
  ChromiumProtocol: () => chromium_default,
  GeckoProtocol: () => gecko_default,
  JsonWProtocol: () => jsonwp_default,
  MJsonWProtocol: () => mjsonwp_default,
  SauceLabsProtocol: () => saucelabs_default,
  SeleniumProtocol: () => selenium_default,
  WebDriverBidiProtocol: () => webdriverBidi_default,
  WebDriverProtocol: () => webdriver_default
});
...
// src/protocols/jsonwp.ts
var DEPRECATION_NOTICE = "This command is deprecated and likely not supported by any browser.";
var TOUCH_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "action" command instead to execute a touch gesture!`;
var GESTURE_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "action" command instead to execute a click gesture!`;
var MOVETO_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "action" command instead to execute a "move to" gesture!`;
var SETTIMEOUTS_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "setTimeouts" command instead!`;
var SESSION_STORAGE_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "execute" command instead to interact with the session storage interface!`;
var LOCAL_STORAGE_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "execute" command instead to interact with the session storage interface!`;
var LOGS_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "devtools" instead to get logs!`;
var POSITION_CLICK_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "action" command instead of "positionClick"!`;
var ELEMENT_SIZE_DEPRECATION_NOTICE = `${DEPRECATION_NOTICE} Use the "getElementRect" command instead of "getElementSize"!`;
var jsonwp_default = {
  "/status": {
    GET: {
      command: "status",
