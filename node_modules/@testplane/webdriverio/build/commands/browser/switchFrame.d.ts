 ...
 */
export declare function switchFrame(this: WebdriverIO.Browser, context: WebdriverIO.Element | ChainablePromiseElement<WebdriverIO.Element> | string | null | ((tree: FlatContextTree) => boolean | Promise<boolean>)): Promise<string | void>;
