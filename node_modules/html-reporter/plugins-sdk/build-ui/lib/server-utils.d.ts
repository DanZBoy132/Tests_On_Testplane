...
import type { TestplaneTestResult, ImageInfoWithState, ReporterConfig, TestSpecByPath } from './types';
...
export declare const getTempPath: (destPath: string) => Promise<string>;
...
export declare function copyFilesToReportDir(destPath: string, ext: string, sourceDirectory: string): Promise<void[]>;
...
export declare const formatTestResult: (rawResult: TestplaneTest | TestplaneTestResult, status: TestStatus, attempt: number | undefined, saveHistoryMode: Config['saveHistoryMode']) => ReporterTestResult;
