...
const pluginMiddlewareRoute_1 = require("../../static/modules/utils/pluginMiddlewareRoute");
const initPluginsRoutes = (router, pluginConfig) => {
    ...
    (0, server_utils_1.forEachPlugin)(pluginConfig.plugins, pluginName => {
        ...
        try {
            ...
            router.use((0, pluginMiddlewareRoute_1.getPluginMiddlewareRoute)(pluginName), pluginRouter);
        }
        catch (err) {
