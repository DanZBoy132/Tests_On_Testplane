...
exports.createTableQuery = exports.mergeTables = exports.handleDatabases = exports.compareDatabaseRowsByTimestamp = exports.createTablesQuery = exports.selectAllSuitesQuery = exports.selectAllQuery = void 0;
...
const createTablesQuery = () => [
    ...
    createTableQuery(constants_1.DB_VERSION_TABLE_NAME, constants_1.VERSION_TABLE_COLUMNS)
];
...
const mergeTables = ({ db, dbPaths, getExistingTables = () => [] }) => {
    db.run(`PRAGMA page_size = ${constants_1.DB_MAX_AVAILABLE_PAGE_SIZE}`);
