...
const testplane_1 = require("../../config/testplane");
...
class TestplaneToolAdapter {
    ...
    constructor(opts) {
        ...
        this._config = testplane_1.TestplaneConfigAdapter.create(this._tool.config);
    ...
    async readTests(paths, cliTool) {
        const { TestplaneTestCollectionAdapter } = await Promise.resolve().then(() => __importStar(require('../../test-collection/testplane')));
