...
const assertFunction = (name) => assertType(name, lodash_1.default.isFunction, 'function');
...
const getParser = () => {
    return (0, gemini_configparser_1.root)((0, gemini_configparser_1.section)({
        ...
        generateBadges: (0, gemini_configparser_1.option)({
            defaultValue: constants_1.configDefaults.generateBadges,
            validate: (value) => lodash_1.default.isNull(value) || assertFunction('generateBadges')
        })
