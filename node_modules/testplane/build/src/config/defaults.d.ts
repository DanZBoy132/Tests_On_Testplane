...
export declare namespace stateOpts {
    let path: null;
    let cookies: boolean;
...
export declare let beforeAll: null;
export declare let afterAll: null;
...
export declare namespace selectivity {
    let enabled: boolean;
    let sourceRoot: string;
    let testDependenciesPath: string;
    let compression: string;
    let disableSelectivityPatterns: never[];
    let mapDependencyRelativePath: null;
}
