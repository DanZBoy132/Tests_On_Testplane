...
class WebdriverPool {
    ...
    async getWebdriver(browserName, browserVersion, { debug = false } = {}) {
        ...
        const { resolveBrowserVersion } = await Promise.resolve().then(() => __importStar(require("../browser-installer")));
    ...
    async createWebdriverProcess(browserName, browserVersion, { debug = false } = {}) {
        const { runBrowserDriver } = await Promise.resolve().then(() => __importStar(require("../browser-installer")));
