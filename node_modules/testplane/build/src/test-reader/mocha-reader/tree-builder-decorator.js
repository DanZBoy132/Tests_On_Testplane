...
class TreeBuilderDecorator {
    ...
    addSuite(mochaSuite) {
        ...
        const suite = __classPrivateFieldGet(this, _TreeBuilderDecorator_instances, "m", _TreeBuilderDecorator_mkTestObject).call(this, Suite, mochaSuite, { id, tags });
    ...
    addTest(mochaTest) {
        ...
        const test = __classPrivateFieldGet(this, _TreeBuilderDecorator_instances, "m", _TreeBuilderDecorator_mkTestObject).call(this, Test, mochaTest, { id, fn, tags });
