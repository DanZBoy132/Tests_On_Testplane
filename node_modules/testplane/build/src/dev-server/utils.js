...
exports.waitDevServerReady = exports.probeServer = exports.pipeLogsWithPrefix = exports.findCwd = void 0;
...
const waitDevServerReady = async (devServer, readinessProbe) => {
    ...
    const readyPromise = new Promise(resolve => {
        const tryToFetch = async () => {
            const isReady = await (0, exports.probeServer)(readinessProbe);
            if (isError || isSuccess) {
                return;
            }
            if (isReady) {
