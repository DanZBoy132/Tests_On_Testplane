...
module.exports = class OneTimeScreenshooter {
    ...
    async _captureScreenshot() {
        ...
        this._screenshot = await promiseTimeout(Promise.resolve(this._makeScreenshot()), this._screenshotTimeout, `timed out after ${this._screenshotTimeout} ms`).catch(e => logger.warn(`WARN: Failed to take screenshot on test fail: ${e}`));
