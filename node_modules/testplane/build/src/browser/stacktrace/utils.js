...
exports.FRAME_RELEVANCE = {
    ...
    wdioInternals: {
        value: 1,
        matcher: fileName => fileName.includes("/node_modules/webdriverio/") || fileName.includes("/gemini-testing/webdriverio/"),
    },
...
const filterExtraStackFrames = (error) => {
    ...
    try {
        ...
        const isIgnoredWebdriverioFrame = (frame) => {
            const isWebdriverioFrame = frame.fileName &&
