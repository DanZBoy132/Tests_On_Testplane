...
export declare const BrowserName: {
    ...
    readonly CHROMEHEADLESSSHELL: PuppeteerBrowser.CHROMEHEADLESSSHELL;
...
declare global {
    namespace WebdriverIO {
        ...
        interface Browser {
            ...
            waitForStaticToLoad: (this: WebdriverIO.Browser, opts?: {
                timeout?: number;
                interval?: number;
            }) => Promise<WaitForStaticToLoadResult>;
            unstable_captureDomSnapshot(this: WebdriverIO.Browser, options?: Partial<CaptureSnapshotOptions>): Promise<CaptureSnapshotResult>;
            unstable_captureDomSnapshot(this: WebdriverIO.Browser, selector: string, options?: Partial<CaptureSnapshotOptions>): Promise<CaptureSnapshotResult>;
        ...
        interface Element {
            ...
            unstable_captureDomSnapshot(this: WebdriverIO.Element, options?: Partial<CaptureSnapshotOptions>): Promise<CaptureSnapshotResult>;
        }
    }
}
export {};
